...
const Subscription = () => {
    ...
    const handleAddEmail = async (e) => {
        ...
        try {
            ...
            const { data } = await axios.post('api/subscription', formData)
            if (data && data.email) {
                setSendEmail(true)
                setChangeEmail('')
            }
        } catch (e) {
            alert('Помилка при відправці email. Спробуйте пізніше')
        }
    }
            ...
            <div className="container">
                <div className="m-subscription d-flex flex-column flex-md-row align-items-md-center">
                    ...
                    <div className="m-subscription-center">
                        <div className="img">
                            <img src="/image/subscr_bg.svg" alt="subscr" />
                        </div>
                    </div>
                    <div className="m-subscription-bottom">
                        {sendEmail ? (
                            ...
                            >
                                Дякуємо, що підписались! ВИ першими дізнаєтесь
                                про наші акційні пропозиції:)
                            </div>
                        ) : (
