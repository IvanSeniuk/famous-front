...
const AboutAdmin = () => {
    ...
    const handleChangeFile = async (e) => {
        try {
            ...
            const { data } = await $authHost.put('api/about/1', formData)
            setDataAbout(data)
        } catch (e) {
    ...
    const handleUpdateData = async (e) => {
        ...
        const dataText = {
            ...
            text1: dataAbout.text1,
            text2: dataAbout.text2,
        }
        try {
            const response = await $authHost.put('api/about/1', dataText)
    ...
    return (
        <form onSubmit={handleUpdateData} className="o-about">
                        ...
                        >
                            ...
                            <defs>
                                ...
                                >
                                    ...
                                    <stop offset="0.0193" stopColor="#AD7712" />
                                    <stop offset="0.1826" stopColor="#A26914" />
                                    <stop offset="0.3236" stopColor="#9E6414" />
                                    <stop offset="0.389" stopColor="#A36C19" />
                                    <stop offset="0.4886" stopColor="#B28126" />
                                    <stop offset="0.6092" stopColor="#C9A33B" />
                                    <stop offset="0.707" stopColor="#E0C44F" />
                                    <stop offset="0.8" stopColor="#DEC14D" />
                                    <stop offset="0.8661" stopColor="#D8B847" />
                                    <stop offset="0.924" stopColor="#CEA83C" />
                                    <stop offset="0.9768" stopColor="#BF922D" />
